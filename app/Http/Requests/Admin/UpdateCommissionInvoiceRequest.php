...
class UpdateCommissionInvoiceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        ...
        return [
            'invoice_number'          => ['nullable', 'string', 'max:255', Rule::unique('commission_invoices', 'invoice_number')->ignore($invoice?->id)],
