...
class StoreInstitutionProgramRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'program_id'           => ['required', 'exists:programs,id', 'unique:institution_programs,program_id,NULL,id,institution_id,' . $this->input('institution_id')],
