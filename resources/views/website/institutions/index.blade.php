...
@section('meta-description', 'Browse and filter top educational institutions by type, location, and more.')
    ...
    <div class="max-w-[1200px] mx-auto px-5 relative z-10">
        <div class="max-w-[800px] mx-auto text-center">
            ...
            <p class="text-[1.2rem] text-white/90 mb-8">
                Browse and compare colleges across Nepal. Filter by location, programs, and institution type to find the right fit for your educational journey.
            </p>
