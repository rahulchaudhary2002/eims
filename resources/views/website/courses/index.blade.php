...
@section('meta-description', 'Browse active courses offered by top institutions. Filter by institution, name, and fee.')
...
<section class="relative overflow-hidden text-white pt-[160px] pb-[60px] bg-gradient-to-br from-[#2c5aa0] to-[#1a365d]">
    ...
    <div class="max-w-[1200px] mx-auto px-5 relative z-10">
        <div class="max-w-[800px] mx-auto text-center">
            ...
            <p class="text-[1.2rem] text-white/90 mb-8">Discover skill-based and professional courses offered by leading institutions.</p>
...
<section id="course-list" class="relative z-10 -mt-10 bg-white rounded-xl shadow-[0_5px_15px_rgba(0,0,0,0.05)] max-w-[1160px] mx-auto px-5 py-10">
    <form method="get" action="{{ route('website.courses.index') }}" class="max-w-[1200px] mx-auto">
        <div class="mb-8">
            ...
            <p class="text-gray-600 text-[1.1rem] max-w-[600px]">Filter courses by name, institution, or maximum fee.</p>
        </div>
        ...
        <div class="flex justify-end gap-3">
            @if(request()->hasAny(['search', 'institution', 'fee_max']))
                <a href="{{ route('website.courses.index') }}" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl font-semibold border-2 border-gray-300 text-gray-600 hover:bg-gray-50 transition">
