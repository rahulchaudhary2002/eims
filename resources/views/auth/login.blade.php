...
@section('title', 'Login to Your Account - Sikuna.com')
        ...
        <div class="bg-white rounded-2xl shadow-[0_6px_20px_rgba(0,0,0,0.1)] overflow-hidden grid md:grid-cols-2">
            ...
            <div class="p-8 md:p-12">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-600">Select your account type and enter your credentials</p>
                </div>

                <!-- User Type Selector -->
                <div class="flex bg-gray-50/80 p-1 rounded-xl mb-8">
                    <button type="button"
                ...
                <!-- Student Login Form -->
                <form method="POST" action="{{ route('login') }}" class="auth-form active space-y-6" id="studentLoginForm">
                    @csrf
                    <!-- Email -->
                    <div>
                        <div class="flex justify-between mb-2">
                            <label for="studentEmail" class="font-semibold text-gray-800">Email Address</label>
                        </div>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                <i class="fas fa-envelope"></i>
                            </span>
                            <input type="email" id="studentEmail" name="username" value="{{ old('username') }}"
                    ...
                    <div>
                        <div class="flex justify-between mb-2">
                            <label for="studentPassword" class="font-semibold text-gray-800">Password</label>
                            @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-[#4299e1] hover:text-[#2c5aa0] font-medium">
                                Forgot Password?
                            </a>
                            @endif
                        </div>
                ...
                <!-- Institution Login Form (hidden by default) -->
                <form method="POST" action="{{ route('vendor.login') }}" class="auth-form hidden space-y-6" id="institutionLoginForm">
                    @csrf
                    <div>
                        <div class="flex justify-between mb-2">
                            <label for="institutionEmail" class="font-semibold text-gray-800">Institution Email</label>
                        </div>
                        <div class="relative">
                            <span class="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400">
                                <i class="fas fa-building"></i>
                            </span>
                            <input type="email" id="institutionEmail" name="username"
                                class="w-full pl-12 pr-4 py-4 border border-gray-200 rounded-xl focus:border-[#4299e1] focus:ring-4 focus:ring-[#4299e1]/10 transition text-base"
                                placeholder="Enter institution email address" required>
                        </div>
                    </div>

                    <div>
                        <div class="flex justify-between mb-2">
                            <label for="institutionPassword" class="font-semibold text-gray-800">Password</label>
                            <a href="{{ route('password.request') }}" class="text-sm text-[#4299e1] hover:text-[#2c5aa0] font-medium">
                                Forgot Password?
                            </a>
                        </div>
                ...
                <div class="relative my-8">
                    ...
                    <div class="relative flex justify-center">
                        <span class="px-5 bg-white text-gray-500 text-sm">Or continue with</span>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <button type="button"
                        class="social-btn google flex items-center justify-center gap-3 py-3.5 px-4 border border-gray-200 rounded-xl hover:border-[#db4437] hover:bg-red-50/50 transition-all duration-300 text-gray-700 font-medium">
                        <i class="fab fa-google text-[#db4437] text-lg"></i>
                        Google
                    </button>
                    <button type="button"
                        class="social-btn facebook flex items-center justify-center gap-3 py-3.5 px-4 border border-gray-200 rounded-xl hover:border-[#3b5998] hover:bg-blue-50/50 transition-all duration-300 text-gray-700 font-medium">
                ...
                <div class="mt-8 text-center text-gray-600">
                    ...
                    <a href="{{ route('register') }}" class="text-[#4299e1] hover:text-[#2c5aa0] font-semibold ml-1">
                        Register now
                    </a>
                </div>
            </div>
