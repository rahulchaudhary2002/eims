...
<div class="space-y-5">
    ...
    <x-admin.page-header title="Upload Document" subtitle="Add a new institution document"
        :breadcrumbs="[
    ...
    <form action="{{ route('admin.institution-documents.store') }}" method="POST"
          enctype="multipart/form-data" class="space-y-5">
        @csrf

        @include('admin.institution-documents.partials.form')

        <div class="flex justify-end gap-3 pb-4">
            <a href="{{ route('admin.institution-documents.index') }}" class="btn btn-secondary">Cancel</a>
