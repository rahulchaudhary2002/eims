...
<div class="space-y-5">
    ...
    <x-admin.page-header
        ...
        :breadcrumbs="[
            ...
            ['label'=>$studentAcademicRecord->student->name,'route'=>'admin.student-academic-records.show','params'=>[$studentAcademicRecord]],
            ['label'=>'Edit'],
        ]">
        <x-slot:actions>
            <a href="{{ route('admin.student-academic-records.show', $studentAcademicRecord) }}" class="btn btn-secondary">
    ...
    <form action="{{ route('admin.student-academic-records.update', $studentAcademicRecord) }}" method="POST"
          enctype="multipart/form-data" class="space-y-5">
        @csrf
        @method('PUT')

        @include('admin.student-academic-records.partials.form')

        <div class="flex justify-end gap-3 pb-4">
            <a href="{{ route('admin.student-academic-records.show', $studentAcademicRecord) }}" class="btn btn-secondary">Cancel</a>
