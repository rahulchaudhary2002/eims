...
<div class="space-y-5">
    ...
    <x-admin.page-header
        title="Create Institution Category"
        subtitle="Add a new category to classify institutions"
        :breadcrumbs="[['label'=>'Dashboard','route'=>'admin.dashboard'],['label'=>'Categories','route' => 'admin.institution-category.index'],['label'=>'Create']]">
        <x-slot:actions>
    ...
    <x-admin.form-card title="Category Details">
        <form action="{{ route('admin.institution-category.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                <x-admin.form-input name="name" label="Category Name" placeholder="Enter category name" required />
                <x-admin.form-input name="slug" label="Slug" placeholder="Auto-generated if left empty" help="Lowercase letters, numbers and hyphens only." />
            </div>
