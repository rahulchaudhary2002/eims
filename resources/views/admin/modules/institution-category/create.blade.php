...
@section('title', 'Create Institution Category')
@section('content')
<div class="bg-white rounded-lg shadow-lg border border-gray-200">
    <div class="p-6 flex justify-between items-center mb-6 bg-white bg-opacity-80 backdrop-blur-sm rounded-t-lg">
        <div>
            <h1 class="text-3xl font-bold text-gray-800">🏷️ Create Institution Category</h1>
            <p class="text-gray-600 mt-1">Add a new institution category</p>
        </div>
    ...
    <div class="px-6 pb-6">
        <div class="bg-white rounded-lg shadow-md p-6">
            <form action="{{ route('admin.institution-category.store') }}" method="POST">
                @csrf
