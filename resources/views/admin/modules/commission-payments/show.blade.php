            ...
            <div class="eims-card p-6">
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4 text-sm">
                    ...
                    <div>
                        ...
                        <dd class="mt-1">
                            @if(storage_exists($commissionPayment->payment_proof))
                                <a href="{{ storage_url($commissionPayment->payment_proof) }}" target="_blank" class="text-blue-600 hover:underline text-sm inline-flex items-center gap-1">
