            ...
            <div class="flex-1 min-w-[200px]">
                ...
                <div class="relative">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}"
                        class="form-control with-icon" placeholder="Name, email, phone, code…">
                </div>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="flex items-center gap-3">
                                ...
                                <img src="{{ storage_url($institution->logo) }}" alt="" class="w-8 h-8 rounded object-contain border border-slate-100 bg-slate-50 shrink-0">
                                @else
