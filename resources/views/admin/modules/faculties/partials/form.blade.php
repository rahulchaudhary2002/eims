...
<div class="eims-card p-6 space-y-5">
    <div class="flex items-center gap-3 pb-4 border-b border-slate-100">
        ...
        <h3 class="text-base font-semibold text-slate-800">Faculty Information</h3>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
        ...
        <div x-data="{ slugEdited: {{ old('slug', isset($faculty) ? $faculty->slug : '') ? 'true' : 'false' }} }">
            ...
            <p class="text-xs text-slate-400 mt-1">Lowercase letters, numbers, and hyphens only. Leave blank to auto-generate.</p>
    ...
    <div>
        <label class="flex items-center gap-3 cursor-pointer w-fit">
            ...
            <input type="checkbox" name="is_active" value="1" class="w-4 h-4 rounded accent-indigo-600"
                {{ old('is_active', ($faculty->is_active ?? true) ? '1' : '0') == '1' ? 'checked' : '' }}>
