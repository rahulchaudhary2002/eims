...
<div class="space-y-5">
    ...
    <x-admin.page-header
        ...
        :breadcrumbs="[
            ...
            ['label'=>$faculty->name,'route' => 'admin.faculties.show','params'=>[$faculty]],
            ['label'=>'Edit'],
        ]">
        <x-slot:actions>
            <a href="{{ route('admin.faculties.show', $faculty) }}" class="btn btn-secondary">
    ...
    <form action="{{ route('admin.faculties.update', $faculty) }}" method="POST" class="space-y-5">
        ...
        @include('admin.modules.faculties.partials.form')

        <div class="flex justify-end gap-3 pb-4">
            <a href="{{ route('admin.faculties.show', $faculty) }}" class="btn btn-secondary">Cancel</a>
