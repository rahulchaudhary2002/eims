...
@section('title', 'Add Scholarship Application')
@section('page-title', 'Add Scholarship Application')

@section('content')
<div class="space-y-5">
    <x-admin.page-header
        title="Add Scholarship Application"
        subtitle="Create a new scholarship application for a student."
        :breadcrumbs="[
