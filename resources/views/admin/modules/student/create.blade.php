...
<div class="space-y-5">
    ...
    <x-admin.page-header title="Add Student" subtitle="Create a new student account"
        :breadcrumbs="[['label'=>'Dashboard','route'=>'admin.dashboard'],['label'=>'Students','route'=>'admin.students.index'],['label'=>'Add Student']]">
        <x-slot:actions>
