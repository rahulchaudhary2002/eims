...
<div class="space-y-5">
    ...
    <x-admin.page-header
        ...
        :breadcrumbs="[
            ...
            ['label'=>$institutionProfile->institution->name ?? 'Profile','route'=>'admin.institution-profiles.show','params'=>[$institutionProfile]],
            ['label'=>'Edit'],
        ]">
        <x-slot:actions>
            <a href="{{ route('admin.institution-profiles.show', $institutionProfile) }}" class="btn btn-secondary">
    ...
    <form action="{{ route('admin.institution-profiles.update', $institutionProfile) }}" method="POST" class="space-y-5">
        @csrf
        @method('PUT')

        @include('admin.institution-profiles.partials.form')

        <div class="flex justify-end gap-3 pb-4">
            <a href="{{ route('admin.institution-profiles.show', $institutionProfile) }}" class="btn btn-secondary">Cancel</a>
