        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div class="relative">
                ...
                <div class="absolute bottom-7 -left-7 bg-white rounded-xl p-5 shadow-lg flex items-center gap-4 border-2 border-gray-200 animate-[float_3s_ease-in-out_infinite] hidden lg:flex" style="animation-delay: 1s">
                    ...
                    <div>
                        <h3 class="text-2xl text-gray-800 mb-1 font-bold">100+</h3>
    ...
    <div class="container max-w-7xl mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-7">
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg transition-all hover:-translate-y-1.5 hover:shadow-2xl">
                <div class="p-7 pb-4 border-b border-gray-200">
                    <div class="flex items-center gap-2.5 mb-4">
                        <img src="https://images.unsplash.com/photo-1562774053-701939374585?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Prime College Logo" class="w-8 h-8 rounded-md object-cover border-2 border-gray-200">
                        <span class="px-4 py-1.5 bg-[#4299e1]/10 text-[#4299e1] rounded-full text-xs font-semibold">Prime College</span>
                    </div>
                    <h3 class="text-2xl text-[#2c5aa0] mb-2.5 leading-tight font-bold">Bachelor in Information Management (BIM)</h3>
                ...
                <div class="p-5 pt-5">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="text-2xl font-bold text-[#2c5aa0] whitespace-nowrap">NPR 4,50,000<small class="text-sm text-gray-600 font-normal">/total</small></div>
                        <a href="prime-college-bim.html" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-semibold cursor-pointer transition-all bg-[#4299e1] text-white text-sm hover:bg-[#2c5aa0] hover:-translate-y-1 hover:shadow-lg">
                            View Program
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg transition-all hover:-translate-y-1.5 hover:shadow-2xl">
                <div class="p-7 pb-4 border-b border-gray-200">
                    <div class="flex items-center gap-2.5 mb-4">
                        <img src="https://images.unsplash.com/photo-1523050854058-8df90110c9f1?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="St. Xavier's Logo" class="w-8 h-8 rounded-md object-cover border-2 border-gray-200">
                        <span class="px-4 py-1.5 bg-[#4299e1]/10 text-[#4299e1] rounded-full text-xs font-semibold">St. Xavier's College</span>
                    </div>
                    <h3 class="text-2xl text-[#2c5aa0] mb-2.5 leading-tight font-bold">Bachelor of Business Studies (BBS)</h3>
                    <div class="text-gray-600 mb-4 flex items-center gap-1.5 text-sm">
                        <i class="fas fa-graduation-cap"></i>
                        <span>4 Years • Bachelor's Degree</span>
                    </div>
                ...
                <div class="p-5 pt-5">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="text-2xl font-bold text-[#2c5aa0] whitespace-nowrap">NPR 3,80,000<small class="text-sm text-gray-600 font-normal">/total</small></div>
                        <a href="stxaviers-bbs.html" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-semibold cursor-pointer transition-all bg-[#4299e1] text-white text-sm hover:bg-[#2c5aa0] hover:-translate-y-1 hover:shadow-lg">
                            View Program
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
            ...
            <div class="bg-white rounded-xl overflow-hidden shadow-lg transition-all hover:-translate-y-1.5 hover:shadow-2xl">
                <div class="p-7 pb-4 border-b border-gray-200">
                    <div class="flex items-center gap-2.5 mb-4">
                        <img src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80" alt="Kantipur Logo" class="w-8 h-8 rounded-md object-cover border-2 border-gray-200">
                        <span class="px-4 py-1.5 bg-[#4299e1]/10 text-[#4299e1] rounded-full text-xs font-semibold">Kantipur College</span>
                    </div>
                    <h3 class="text-2xl text-[#2c5aa0] mb-2.5 leading-tight font-bold">Computer Engineering (BE)</h3>
                    <div class="text-gray-600 mb-4 flex items-center gap-1.5 text-sm">
                        <i class="fas fa-graduation-cap"></i>
                        <span>4 Years • Bachelor's Degree</span>
                    </div>
                ...
                <div class="p-5 pt-5">
                    ...
                    <div class="flex justify-between items-center">
                        <div class="text-2xl font-bold text-[#2c5aa0] whitespace-nowrap">NPR 5,20,000<small class="text-sm text-gray-600 font-normal">/total</small></div>
                        <a href="kantipur-engineering.html" class="inline-flex items-center gap-2 px-4 py-2 rounded-xl font-semibold cursor-pointer transition-all bg-[#4299e1] text-white text-sm hover:bg-[#2c5aa0] hover:-translate-y-1 hover:shadow-lg">
                            View Program
                            <i class="fas fa-arrow-right"></i>
                        </a>
                    </div>
                ...
                <div class="p-7">
                    ...
                    <div class="flex justify-between pt-4 border-t border-gray-200">
                        <div class="text-center">
                            <span class="text-lg font-bold text-[#2c5aa0] block">{{ $college->courses()->count() }}+</span>
